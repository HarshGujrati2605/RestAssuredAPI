...
public class oAuthTest extends GlobalVariable {

	@Test(priority = 1, testName = "Post the course HTML")
	...
	@Test(dependsOnMethods = "postHtml")

	public void getCourseValidation() {
...
//		System.out.println(gc.getCourses().getApi().get(1).getCourseTitle());
		...
		apiCourses = gc.getCourses().getApi();
